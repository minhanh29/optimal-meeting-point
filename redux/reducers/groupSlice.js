...
export const ADD_MEMBER_PENDING = 14
export const ADD_MEMBER_REJECTED = 15
export const ADD_MEMBER_SUCCESS = 16
...
export const createGroupAsync = createAsyncThunk('group/createGroupAsync', async (data) => {
    ...
    const res2 = await createGroupandUser({ group_address: new GeoPoint(data.user_location.latitude, data.user_location.longitude), group_id: res.id, role: "host", user_id: data.user_id })
